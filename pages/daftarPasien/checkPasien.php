...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_num_rows($queryCekKTP) > 0) {
        ...
        if (mysqli_num_rows($query) < 1) {
            ...
            if ($queryInsert) {
                echo '<script>alert("Pendaftaran pasien berhasil");window.location.href="../../daftarPasien.php";</script>';
            } else {
                echo '<script>alert("Pendaftaran pasien gagal");window.location.href="../../daftarPasien.php";</script>';
            }
        } else {
